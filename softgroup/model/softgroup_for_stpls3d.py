...
class SoftGroup(nn.Module):
    ...
    def forward_grouping(self,
        ...
        for class_id in range(self.semantic_classes):
            ...
            # boziadd>>>
            # '''
            if class_id in [1]: # building
                a = 1.7
            elif class_id in [2]: # low vegetation
                a = 1
            elif class_id in [3]: # med. vegetation
                a = 0.5
            elif class_id in [4]: # high vegetation
                a = 1.6
            elif class_id in [5]: # vehicle
                a = 1
            elif class_id in [6]: # truck
                a = 1.3
            elif class_id in [7]: # aircraft
                a = 1
            elif class_id in [8]: # militaryVehicle
                a = 0.5
            elif class_id in [9]: # bike
                a = 0.2
            elif class_id in [10]: # motorcycle
                a = 0.7
            elif class_id in [11]: # light pole
                a = 0.9
            elif class_id in [12]: # street sign
                a = 0.5
            elif class_id in [13]: # clutter
                a = 0.8
            elif class_id in [14]: # fence
                a = 1.7
            else:
                a = 1
            # '''

            # print("class_id:{} a:{}".format(class_id, a))
            # a = 1.9
            # print(a)
            # boziadd<<<
