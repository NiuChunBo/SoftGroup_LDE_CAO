...
if __name__ == '__main__':
    ...
    data_path = '/wdc/ncb-old/datasets/s3dis/area5_val/'
    results_path = '/wdc/ncb-old/SoftGroup_multi_versions_manage_2023-11-10/SoftGroup/vis_self/pniv_ablation_results'
