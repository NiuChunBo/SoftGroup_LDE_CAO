...
def get_coords_color(opt):
    ...
    # same color order according to instance pointnum
        ...
        # boziadd>>>
        print("inst_label:{}".format(inst_label))
        print(opt.room_name)
        # save
        np.save("/wdc/ncb-old/SoftGroup_multi_versions_manage/SoftGroup/results_2_for_eval_11_2/ins_label_from_visualization/" + opt.room_name + '.npy', inst_label)
        # boziadd<<<
