...
def process_file(scan_path):
    pcd = o3d.io.read_point_cloud('../my_results/semantic_gt/' + scan_path.rstrip('_instance_gt.ply') + '_semantic_gt.ply')
    ...
    o3d.visualization.draw_geometries([pcd], 'sem_gt of ' + scan_path.rstrip('_instance_gt.ply'), 1920, 1080, 0, 0)
...
if __name__ == "__main__":
    ...
    # 使用 "file_path" 参数
    print("File path:", '../my_results/semantic_gt/' + args.file_path.rstrip('_instance_gt.ply') + '_semantic_gt.ply')
    # 获取命令行参数
    if len(sys.argv) > 1:
